...
import { fetchUserAgentInfoData } from './services/fetchUserAgentInfoData';
...
const updateUserAgentData = async (timeRange) => {
    try {
        const data = await fetchUserAgentInfoData(timeRange);
...
<template>
<div class="max-w-lg  w-full border-1 bg-white rounded-sm shadow p-4 md:p-6">
