...
<footer class="bg-white border-t dark:border-gray-600 dark:text-white dark:bg-zinc-700">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 ">
            ...
            <div>
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-300 font-medium">
                      ...
                      <li>
                          <Link :href="route('conditions')" class="hover:underline">Terms &amp; Conditions</Link>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-300">© 2024 <Link :href="route('home')" class="hover:underline">EducaFree™</Link>. All Rights Reserved.
          </span>


          <div class="flex mt-4 sm:justify-center sm:mt-0 dark:text-gray-300">
              <a href="https://www.facebook.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-300">
                  <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                    </svg>
              </a>
              <a href="https://www.discord.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 ms-5 dark:text-gray-300">
              ...
              <a href="https://www.x.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 ms-5 dark:text-gray-300">
              ...
              <a href="https://github.com/GarriguesN/TFG" class="text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 ms-5 dark:text-gray-300">
