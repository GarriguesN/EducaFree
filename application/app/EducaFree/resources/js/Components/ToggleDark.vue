    ...
    <template>
        <button v-if="!props.alwaysLight" @click="toggleDark()" class="flex items-center align-middle">
            <p v-if="isDark" class="text-xs hidden min-[950px]:block mr-1"> Dark</p>
            ...
            <p v-if="!isDark" class="text-xs hidden min-[950px]:block mr-1">Light</p>
